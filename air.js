function init() {
  ...
  let bannerContent = '#Im Captain Meowlot#Sid hired us to say# Happy Birthday To#His Baby Ada#a wow celebration#From 30k feet in the air#Just for you#Im hungry#Just here for tuna#Im scared of heights#Sid didnt pay me#We are landing#Happy Birthday Ada♥#'
  const banners = []
  let spriteId = 0
  let topIndex = 3
  let count = 0
